...
interface InterruptFormBusinessNeedDescriptionProps {
  inputCount: number;
  onSubmit: (responses: string) => void;
}

export default function InterruptFormBusinessNeedDescription({ inputCount, onSubmit }: InterruptFormBusinessNeedDescriptionProps) {
  ...
  return (
    <div className="p-4 rounded-lg bg-surface-light dark:bg-surface-dark border border-border-light dark:border-border-dark">
      ...
      <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">
        Describe the business need clearly and concisely. For example:
