...
Você DEVE retornar APENAS um array JSON válido (sem markdown, sem explicação). O array deve conter {quantity} sub-arrays, um por impacto positivo, na mesma ordem. Cada sub-array deve conter exatamente 3 strings, cada uma sendo uma pergunta contextual concisa (até 250 caracteres).
